...
public class UpdateActivity extends Activity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if(extras != null) {
            String fName = extras.getString(MainActivity.MAIN_FNAME);
            String lName = extras.getString(MainActivity.MAIN_LNAME);
            String presence = extras.getString(MainActivity.MAIN_STATUS);
            if( fName != null) {
            ...
            etFName.setText("");
            etLName.setText("");
            getIntent().putExtra(MainActivity.MAIN_ID, "-1");
        }
            ...
            public void onClick(View v) {
                try {
                    if (etFName.getText().toString().equals("") && etLName.getText().toString().equals("")) {
                        ...
                        String _id = getIntent().getStringExtra(MainActivity.MAIN_ID);
                        if(!_id.equals("-1")) {
